...
class DemonCommand extends commando.Command
{
    ...
    async run(message , args)
    {
        var myinfo = new discord.RichEmbed()
            ...
            .addField("<:tank:567647267171991564> **Most**", "[ссылка на гайд](https://www.icy-veins.com/wow/blood-death-knight-pve-tank-guide)" + ("https://bloodmallet.com/index.html#death_knight_blood"), true)
